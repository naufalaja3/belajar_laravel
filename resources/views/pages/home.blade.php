...
🚀
 MVC Architecture</h5>
                    <p class="card-text">                         Pelajari konsep Model-View-Controller yang
terstruktur
                        dan modular untuk pengembangan aplikasi yang
scalable.
                    </p>
                </div>
            </div>
...
🎨
 Blade Template</h5>
                    <p class="card-text">
                        ...
                        web yang dinamis dan reusable dengan sintaks yang
bersih.
                    </p>
                </div>
            </div>
