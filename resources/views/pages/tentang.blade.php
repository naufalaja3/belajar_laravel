...
@section('content')
    ...
    <div class="row g-4">
        <div class="col-md-8">
            ...
            <p class="lead">
                Modul Praktikum Laravel adalah panduan lengkap untuk
mempelajari
                pengembangan web menggunakan framework Laravel 13.
            </p>
            <p>
                Modul ini dirancang untuk mahasiswa semester awal yang baru
mulai belajar pemrograman web. Setiap bab disusun secara sistematis
                dengan penjelasan yang mudah dipahami dan contoh kode yang
dapat
...
📊
 Info Modul</div>
                <ul class="list-group list-group-flush">
                    <li class="list-group-item bg-dark text-white d-flex
